...
description: a modified version of generatefixtures.py used to generate files for testing purposes
original: https://github.com/AgencyPMG/ProgrammingChallenges/blob/master/csv-combiner/generatefixtures.py
modified version author: abdullah al hamoud
"""
import csv
import hashlib
